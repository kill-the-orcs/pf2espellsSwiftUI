        ...
        VStack(alignment: .leading) {
            ...
            HStack {
                ...
                trait in
                    ...
                    .fontWeight(.bold)
                    .padding(1)
                    .background(Self.colors[trait, default: Color(#colorLiteral(red: 0.6072533312, green: 0.01705050273, blue: 0, alpha: 1))])
                    .foregroundColor(.white)
...
struct PrepDetail_Previews: PreviewProvider {
